...
<html lang="en">
    ...
    <body>
        		...
        		<div class="row offer_inner">
        			<div class="col-lg-4">
        				<div class="offer_item">
        					<img class="img-fluid" src="<?php echo base_url().'assets/img/offer/offer-1.jpg';
                            ?>" alt="">
        			...
        			<div class="col-lg-4">
        				<div class="offer_item">
        					<img class="img-fluid" src="<?php echo base_url().'assets/img/offer/offer-2.jpg';?>" alt="">
        					<div class="offer_text">
        						<h4>Addiction Whit Gambling</h4>
        						<p>It is a good idea to think of your PC as an office. It stores files, programs, pictures. This can be compared to an actual.</p>
        					</div>
        			...
        			<div class="col-lg-4">
        				<div class="offer_item">
        					<img class="img-fluid" src="<?php echo base_url().'assets/img/offer/offer-3.jpg';?>" alt="">
        					<div class="offer_text">
        						<h4>Addiction Whit Gambling</h4>
        						<p>It is a good idea to think of your PC as an office. It stores files, programs, pictures. This can be compared to an actual.</p>
        					</div>
        	...
        	<div class="container">
        		<div class="gallery_f_inner row imageGallery1">
        			<div class="col-lg-4 col-md-4 col-sm-6 brand manipul design print">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="<?php echo base_url().'assets/img/gallery/project-1.jpg';?>" alt="">
        						<a class="light" href="<?php echo base_url().'assets/img/gallery/project-1.jpg';?>"><img src="<?php echo base_url().'assets/img/gallery/icon.png';?>" alt=""></a>
        					</div>
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand manipul creative">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="<?php echo base_url().'assets/img/gallery/project-2.jpg';?>" alt="">
        						<a class="light" href="<?php echo base_url().'assets/img/gallery/project-2.jpg';?>"><img src="<?php echo base_url().'assets/img/gallery/icon.png';?>" alt=""></a>
        					</div>
        					<div class="g_item_text">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 manipul creative design print">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="<?php echo base_url().'assets/img/gallery/project-3.jpg';?>" alt="">
        						<a class="light" href="<?php echo base_url().'assets/img/gallery/project-3.jpg';?>"><img src="<?php echo base_url().'assets/img/gallery/icon.png';?>" alt=""></a>
        					</div>
        					<div class="g_item_text">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand creative print">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="<?php echo base_url().'assets/img/gallery/project-4.jpg'; ?> " alt="">
        						<a class="light" href="<?php echo base_url().'assets/img/gallery/project-4.jpg';?>"><img src="<?php echo base_url().'assets/img/gallery/icon.png';?>" alt=""></a>
        					</div>
        					<div class="g_item_text">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand manipul design">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="<?php echo base_url().'assets/img/gallery/project-5.jpg';?>" alt="">
        						<a class="light" href="<?php echo base_url().'assets/img/gallery/project-5.jpg';?>"><img src="<?php echo base_url().'assets/img/gallery/icon.png';?>" alt=""></a>
        					</div>
        					<div class="g_item_text">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand creative">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="<?php echo base_url().'assets/img/gallery/project-6.jpg';?>" alt="">
        						<a class="light" href="<?php echo base_url().'assets/img/gallery/project-6.jpg';?>"><img src="<?php echo base_url().'assets/img/gallery/icon.png';?>" alt=""></a>
        					</div>
        					<div class="g_item_text">
        ...
        <section class="home_contact_area">
			<div class="left_img">
				<img src="<?php echo base_url().'assets/img/left-img.jpg';?>" alt="">
			</div>
        	...
        	<div class="container">
        		...
        		<div class="row latest_blog_inner">
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<div class="l_blog_img">
        						<img class="img-fluid" src="<?php echo base_url().'assets/img/blog/latest-post/l-post-1.jpg'; ?> " alt="">
        					</div>
        			...
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<div class="l_blog_img">
        						<img class="img-fluid" src="<?php echo base_url().'assets/img/blog/latest-post/l-post-2.jpg';?>" alt="">
        					</div>
        					<div class="l_blog_text">
        						<div class="date">
        							<a href="#">25 October, 2017  |  By Mark Wiens</a>
        			...
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<div class="l_blog_img">
        						<img class="img-fluid" src="<?php echo base_url().'assets/img/blog/latest-post/l-post-3.jpg';?>" alt="">
        					</div>
        					<div class="l_blog_text">
        						<div class="date">
        							<a href="#">25 October, 2017  |  By Mark Wiens</a>
        			...
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<div class="l_blog_img">
        						<img class="img-fluid" src="<?php echo base_url().'assets/img/blog/latest-post/l-post-4.jpg';?>" alt="">
        					</div>
        					<div class="l_blog_text">
        						<div class="date">
        							<a href="#">25 October, 2017  |  By Mark Wiens</a>
